...
@cross_origin()
def video_feed():
    # serialPort = request.form['serial_port']
    # camera = request.form['camera']
    # tracking_enabled = request.form['tracking']
    # recording_enabled = request.form['recording']

    # Open the video capture
    # cap = EasyPySpin.VideoCapture(camera)
    cap = EasyPySpin.VideoCapture(3)
