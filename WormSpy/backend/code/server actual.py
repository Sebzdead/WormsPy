...
def main(deviceList):
    ...
    while True:
        ...
        cv2.circle(img_show, posArr[0], noseTipColor, circleThickness)
        cv2.circle(img_show, posArr[1], pharynxColor, circleThickness)
        cv2.circle(img_show, posArr[2], nerveRingColor, circleThickness)
        cv2.circle(img_show, posArr[3], midbody1Color, circleThickness)
        cv2.circle(img_show, posArr[4], midbody2Color, circleThickness)
        cv2.circle(img_show, posArr[5], midbody3Color, circleThickness)
        cv2.circle(img_show, posArr[6], tailBaseColor, circleThickness)
        cv2.circle(img_show, posArr[7], tailTipColor, circleThickness)
